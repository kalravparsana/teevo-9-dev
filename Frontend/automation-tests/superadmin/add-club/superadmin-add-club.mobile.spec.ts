...
test.describe('Teevo R1 > Add Club — Mobile: iPhone 14', () => {
...
test.describe('Teevo R1 > Add Club — Mobile: iPhone SE', () => {
...
test.describe('Teevo R1 > Add Club — Mobile: Android 360', () => {
...
test.describe('Teevo R1 > Add Club — Mobile: iPad', () => {
