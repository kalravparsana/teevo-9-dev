...
test.describe('Teevo R1 > Club Details — Mobile: iPhone 14', () => {
...
test.describe('Teevo R1 > Club Details — Mobile: iPhone SE', () => {
...
test.describe('Teevo R1 > Club Details — Mobile: Android 360', () => {
...
test.describe('Teevo R1 > Club Details — Mobile: iPad', () => {
