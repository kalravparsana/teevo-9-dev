...
test.describe('Teevo R1 > Tee Time Slots — Mobile: iPhone 14', () => {
...
test.describe('Teevo R1 > Tee Time Slots — Mobile: iPhone SE', () => {
...
test.describe('Teevo R1 > Tee Time Slots — Mobile: Android 360', () => {
...
test.describe('Teevo R1 > Tee Time Slots — Mobile: iPad', () => {
