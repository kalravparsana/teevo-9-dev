...
test.describe('Teevo R1 > Tournament Management — Mobile: iPhone 14', () => {
...
test.describe('Teevo R1 > Tournament Management — Mobile: iPhone SE', () => {
...
test.describe('Teevo R1 > Tournament Management — Mobile: Android 360', () => {
...
test.describe('Teevo R1 > Tournament Management — Mobile: iPad', () => {
