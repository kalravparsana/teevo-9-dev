...
test.describe('Teevo R1 > Game Bookings — Mobile: iPhone 14', () => {
...
test.describe('Teevo R1 > Game Bookings — Mobile: iPhone SE', () => {
...
test.describe('Teevo R1 > Game Bookings — Mobile: Android 360', () => {
...
test.describe('Teevo R1 > Game Bookings — Mobile: iPad', () => {
