...
test.describe('Teevo R1 > Operating Hours — Mobile: iPhone 14', () => {
...
test.describe('Teevo R1 > Operating Hours — Mobile: iPhone SE', () => {
...
test.describe('Teevo R1 > Operating Hours — Mobile: Android 360', () => {
...
test.describe('Teevo R1 > Operating Hours — Mobile: iPad', () => {
