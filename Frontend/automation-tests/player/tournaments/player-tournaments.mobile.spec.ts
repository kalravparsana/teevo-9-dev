...
test.describe('Teevo R1 > Upcoming Tournaments — Mobile: iPhone 14', () => {
...
test.describe('Teevo R1 > Upcoming Tournaments — Mobile: iPhone SE', () => {
...
test.describe('Teevo R1 > Upcoming Tournaments — Mobile: Android 360', () => {
...
test.describe('Teevo R1 > Upcoming Tournaments — Mobile: iPad', () => {
