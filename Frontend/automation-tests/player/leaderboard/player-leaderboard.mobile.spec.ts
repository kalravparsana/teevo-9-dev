...
test.describe('Teevo R1 > Tournament Leaderboard — Mobile: iPhone 14', () => {
...
test.describe('Teevo R1 > Tournament Leaderboard — Mobile: iPhone SE', () => {
...
test.describe('Teevo R1 > Tournament Leaderboard — Mobile: Android 360', () => {
...
test.describe('Teevo R1 > Tournament Leaderboard — Mobile: iPad', () => {
